...
@interface ICXKeychainUtil (PrivateMethods)
+ (SecKeychainItemRef) getKeychainItemReferenceForUsername: (NSString *) username andServiceName: (NSString *) serviceName error: (NSError **) error;
@end
#endif

@implementation ICXKeychainUtil
...
+ (void)setOpenUDID:(NSString *)openUDID {
    ...
    [self storeUsername:openUDIDName andPassword:openUDID forServiceName:serviceName updateExisting:YES error:NULL];
}

+ (NSString *)openUDID {
    return [self getPasswordForUsername:openUDIDName andServiceName:serviceName error:NULL];
}
